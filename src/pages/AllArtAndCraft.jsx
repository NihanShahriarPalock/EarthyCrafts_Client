...
const AllArtAndCraft = () => {
  ...
  return (
    <div className='container mx-auto px-4 py-8 bg-slate-50'>
      <h2 className='text-2xl font-bold mb-4 text-center text-black py-4'>All Art and Craft Items</h2>
          ...
          <tbody>
            {crafts.map((craft, index) => (
              <tr
                ...
                <td className='border py-2 text-black text-center'>{craft.item_name}</td>
                <td className='border py-2 text-black text-center'>{craft.subcategory_Name}</td>
                <td className='border py-2 text-black text-center'>{craft.customization}</td>
